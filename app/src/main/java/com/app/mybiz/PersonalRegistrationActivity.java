...
//                .build();
        ...
        google_sign_in_btn.setOnClickListener(v -> {
        ...
        facebookCoverBtn.setOnClickListener(v -> {
            pb.setVisibility(View.VISIBLE);
    ...
    private void signInWithFacebook(AccessToken token) {
        ...
        getSharedPreferences(PreferenceKeys.PREFERENCES, MODE_PRIVATE).edit().putString("facebookToken", token.getToken().toString()).commit();
                ...
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        alertDialogBuilder
                                ...
                                .setCancelable(false)
                                .setPositiveButton("google", (dialog, id) -> dialog.dismiss())
                                .setNegativeButton("facebook", (dialog, which) -> dialog.dismiss());
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            task.addOnCompleteListener(task12 -> {
                if (task12.isSuccessful()) {
                    ...
                    task12.addOnCompleteListener(task1 -> {
...
//                                .setMessage("oops..., something went wrong, please try again..")
        ...
        private void signInAndContinue (Task < AuthResult > task) {
            ...
            prefs.edit().putString(PreferenceKeys.APP_ID, uid)
                    ...
                    .putString(PreferenceKeys.NAME, name).apply();
...
//                        Service service = user1.getServices().get(user1.getServices().values().iterator().next());
                            getSharedPreferences(PreferenceKeys.PREFERENCES, MODE_PRIVATE).edit()
                                    ...
                                    .putBoolean(PreferenceKeys.IS_SERVICE, true).apply();
...
//                    finish();
        ...
        private void firebaseAuthWithGoogle(GoogleSignInAccount account){
            ...
            getSharedPreferences(PreferenceKeys.PREFERENCES, MODE_PRIVATE).edit().putString("googleToken", account.getIdToken()).commit();
